 ...
 * Elle doit être appelée par un objet de type bool.
 * Elle peut prendre comme second argument un objet de type bool,
 * ou un atome JarvisBool.
 * 
 */


public class BooleanAndFunction extends JarvisFunction{
	...
	/*
	 * Méthode qui implante la fonction de AND boolean. 
	 * 
	 */
	...
	protected JarvisAtom execute(JarvisInterpreter ji,JarvisObject self) {
		...
		//Finalement, le clou du spectacle, un ET boolean
		boolean and = bool1.getValue() && bool2.getValue();
