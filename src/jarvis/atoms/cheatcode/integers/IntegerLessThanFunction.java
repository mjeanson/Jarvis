...
public class IntegerLessThanFunction extends JarvisFunction{
	...
	/*
	 * Méthode qui implante la fonction de plus petit que. 
	 * 
	 */
	...
	protected JarvisAtom execute(JarvisInterpreter ji,JarvisObject self) {
		...
		boolean less = num1.getValue() < num2.getValue();
	...
	public String makeKey() {
		...
		return "IntegerLessThanFunction";
	}
